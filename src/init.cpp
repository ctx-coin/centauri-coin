...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/centauri-project/centauri>";
    const std::string URL_WEBSITE = "<https://centauri.org>";
