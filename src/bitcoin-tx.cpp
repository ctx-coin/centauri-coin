...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s centauri-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  centauri-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded centauri transaction") + "\n" +
              "  centauri-tx [options] -create [commands]   " + _("Create hex-encoded centauri transaction") + "\n" +
              "\n";
