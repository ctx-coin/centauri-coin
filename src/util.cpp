...
const char * const BITCOIN_CONF_FILENAME = "centauri.conf";
const char * const BITCOIN_PID_FILENAME = "centauri.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Centauri";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Centauri";
#else
    // Unix
    return pathRet / ".centauri";
#endif
#endif
}
